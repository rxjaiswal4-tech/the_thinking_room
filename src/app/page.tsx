...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-[#2C2A29] font-sans antialiased selection:bg-[#E8E2D9]">
      ...
      <main>
        ...
        <section className="max-w-3xl mx-auto px-6 pt-24 pb-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/read" 
              className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-[#2C2A29] text-[#FAF8F5] font-medium hover:bg-opacity-90 transition-all"
            >
              Read Contemporary Verse
            </Link>
            <Link 
              href="/editor" 
              className="w-full sm:w-auto px-8 py-3.5 rounded-full border border-[#D5C9B8] hover:border-[#2C2A29] transition-all"
            >
              Try Distraction-Free Editor
            </Link>
          </div>
        </section>
...
and time forgets its pace.`}
            ...
            <div className="flex items-center justify-between pt-6 border-t border-[#E3D9CC]/60">
              ...
              <button className="text-xs font-semibold uppercase tracking-wider text-[#2C2A29] hover:underline">
                Read Collection →
              </button>
            </div>
          </div>
        ...
        <section id="features" className="max-w-5xl mx-auto px-6 py-20 border-t border-[#EADFCF]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 rounded-xl bg-white/40 border border-[#EADFCF]/70">
              <div className="text-xl mb-3">✒️</div>
              <h3 className="font-serif text-lg font-medium mb-2">Preserved Formatting</h3>
            ...
            <div className="p-6 rounded-xl bg-white/40 border border-[#EADFCF]/70">
              ...
              <h3 className="font-serif text-lg font-medium mb-2">Spoken Word Audio</h3>
              <p className="text-sm text-[#5A5654] leading-relaxed">
            ...
            <div className="p-6 rounded-xl bg-white/40 border border-[#EADFCF]/70">
              <div className="text-xl mb-3">📖</div>
              <h3 className="font-serif text-lg font-medium mb-2">Digital Chapbooks</h3>
              <p className="text-sm text-[#5A5654] leading-relaxed">
      ...
      {/* Minimal Footer */}
      <footer className="border-t border-[#EADFCF] py-8 text-center text-xs text-[#7C7775]">
        <p>© {new Date().getFullYear()} Stanza Inc. Built for writers and readers.</p>
      </footer>
    </div>
  );
}